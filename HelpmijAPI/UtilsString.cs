...
namespace mvdw.helpmij.utils
{
    ...
    internal class UtilsString
    {
        ...
        /// <param name="start">De voorgaande string</param>
        /// <param name="end">De achterliggende string</param>
        /// <returns>Alle gevonden resultaten</returns>
        public static List<String> GetSubStrings(string input, string start, string end)
        {
